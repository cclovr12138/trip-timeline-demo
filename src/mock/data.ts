...
export const trips: MockTrip[] = [
  ...
  { id: 'T010', empId: 'E010', city: '杭州', tripType: 'domestic', startTime: getRelativeDate(-2), endTime: getRelativeDate(-1), status: 'finished' },
  ...
  { id: 'T012', empId: 'E003', city: '武汉', tripType: 'domestic', startTime: getRelativeDate(-3), endTime: getRelativeDate(-1), status: 'finished' },
  { id: 'T013', empId: 'E011', city: '西安', tripType: 'domestic', startTime: getRelativeDate(-7), endTime: getRelativeDate(-3), status: 'finished' },
  { id: 'T014', empId: 'E012', city: '南京', tripType: 'domestic', startTime: getRelativeDate(2), endTime: getRelativeDate(5), status: 'upcoming' },
  { id: 'T015', empId: 'E013', city: '迪拜', tripType: 'overseas', startTime: getRelativeDate(-8), endTime: getRelativeDate(-2), status: 'finished' },
  { id: 'T016', empId: 'E014', city: '重庆', tripType: 'domestic', startTime: getRelativeDate(-1), endTime: getRelativeDate(3), status: 'ongoing' },
  { id: 'T017', empId: 'E015', city: '悉尼', tripType: 'overseas', startTime: getRelativeDate(5), endTime: getRelativeDate(12), status: 'upcoming' },
  { id: 'T018', empId: 'E002', city: '大阪', tripType: 'overseas', startTime: getRelativeDate(-3), endTime: getRelativeDate(2), status: 'ongoing', assistants: [{ name: '山本一郎', email: 'yamamoto@example.com', phone: '+81-80-9876-5432' }] },
  { id: 'T019', empId: 'E004', city: '天津', tripType: 'domestic', startTime: getRelativeDate(-5), endTime: getRelativeDate(-2), status: 'finished' },
  { id: 'T020', empId: 'E005', city: '墨尔本', tripType: 'overseas', startTime: getRelativeDate(8), endTime: getRelativeDate(14), status: 'upcoming' },
  { id: 'T021', empId: 'E006', city: '苏州', tripType: 'domestic', startTime: getRelativeDate(-2), endTime: getRelativeDate(1), status: 'ongoing' },
  { id: 'T022', empId: 'E007', city: '伦敦', tripType: 'overseas', startTime: getRelativeDate(-10), endTime: getRelativeDate(-5), status: 'finished' },
  { id: 'T023', empId: 'E008', city: '厦门', tripType: 'domestic', startTime: getRelativeDate(1), endTime: getRelativeDate(4), status: 'upcoming' },
  ...
  { id: 'T025', empId: 'E010', city: '济南', tripType: 'domestic', startTime: getRelativeDate(-6), endTime: getRelativeDate(-4), status: 'finished' },
  { id: 'T026', empId: 'E011', city: '曼谷', tripType: 'overseas', startTime: getRelativeDate(3), endTime: getRelativeDate(7), status: 'upcoming' },
  ...
  { id: 'T029', empId: 'E014', city: '长沙', tripType: 'domestic', startTime: getRelativeDate(-1), endTime: getRelativeDate(1), status: 'ongoing' },
  { id: 'T030', empId: 'E015', city: '法兰克福', tripType: 'overseas', startTime: getRelativeDate(6), endTime: getRelativeDate(11), status: 'upcoming' },
  { id: 'T031', empId: 'E001', city: '武汉', tripType: 'domestic', startTime: getRelativeDate(15), endTime: getRelativeDate(18), status: 'upcoming' },
  { id: 'T032', empId: 'E002', city: '台北', tripType: 'overseas', startTime: getRelativeDate(-7), endTime: getRelativeDate(-2), status: 'finished' },
  { id: 'T033', empId: 'E003', city: '大连', tripType: 'domestic', startTime: getRelativeDate(-3), endTime: getRelativeDate(0), status: 'ongoing' },
  { id: 'T034', empId: 'E004', city: '米兰', tripType: 'overseas', startTime: getRelativeDate(10), endTime: getRelativeDate(15), status: 'upcoming' },
  { id: 'T035', empId: 'E005', city: '沈阳', tripType: 'domestic', startTime: getRelativeDate(-8), endTime: getRelativeDate(-5), status: 'finished' },
  { id: 'T036', empId: 'E006', city: '三亚', tripType: 'domestic', startTime: getRelativeDate(2), endTime: getRelativeDate(5), status: 'upcoming' },
  { id: 'T037', empId: 'E007', city: '巴黎', tripType: 'overseas', startTime: getRelativeDate(-5), endTime: getRelativeDate(1), status: 'ongoing', assistants: [{ name: 'Jean Dupont', email: 'jean.dupont@example.com', phone: '+33-6-1234-5678' }] },
  { id: 'T038', empId: 'E008', city: '昆明', tripType: 'domestic', startTime: getRelativeDate(-4), endTime: getRelativeDate(-1), status: 'finished' },
  { id: 'T039', empId: 'E009', city: '吉隆坡', tripType: 'overseas', startTime: getRelativeDate(4), endTime: getRelativeDate(9), status: 'upcoming' },
  { id: 'T040', empId: 'E010', city: '石家庄', tripType: 'domestic', startTime: getRelativeDate(-1), endTime: getRelativeDate(2), status: 'ongoing' },
  { id: 'T041', empId: 'E011', city: '洛杉矶', tripType: 'overseas', startTime: getRelativeDate(-6), endTime: getRelativeDate(0), status: 'ongoing', assistants: [{ name: 'John Smith', email: 'john.s@example.com', phone: '+1-310-555-0101' }] },
  { id: 'T042', empId: 'E012', city: '无锡', tripType: 'domestic', startTime: getRelativeDate(-10), endTime: getRelativeDate(-6), status: 'finished' },
  { id: 'T043', empId: 'E013', city: '阿姆斯特丹', tripType: 'overseas', startTime: getRelativeDate(7), endTime: getRelativeDate(12), status: 'upcoming' },
  { id: 'T044', empId: 'E014', city: '南昌', tripType: 'domestic', startTime: getRelativeDate(-2), endTime: getRelativeDate(1), status: 'ongoing' },
  { id: 'T045', empId: 'E015', city: '开罗', tripType: 'overseas', startTime: getRelativeDate(-12), endTime: getRelativeDate(-7), status: 'finished' },
  { id: 'T046', empId: 'E001', city: '郑州', tripType: 'domestic', startTime: getRelativeDate(-4), endTime: getRelativeDate(-1), status: 'finished' },
  { id: 'T047', empId: 'E002', city: '胡志明市', tripType: 'overseas', startTime: getRelativeDate(1), endTime: getRelativeDate(5), status: 'upcoming' },
  { id: 'T048', empId: 'E003', city: '哈尔滨', tripType: 'domestic', startTime: getRelativeDate(-9), endTime: getRelativeDate(-5), status: 'finished' },
  { id: 'T049', empId: 'E004', city: '芝加哥', tripType: 'overseas', startTime: getRelativeDate(-2), endTime: getRelativeDate(3), status: 'ongoing', assistants: [{ name: 'Tom Wilson', email: 'tom.w@example.com', phone: '+1-312-555-0202' }] },
  { id: 'T050', empId: 'E005', city: '贵阳', tripType: 'domestic', startTime: getRelativeDate(3), endTime: getRelativeDate(6), status: 'upcoming' },
  { id: 'T051', empId: 'E006', city: '雅加达', tripType: 'overseas', startTime: getRelativeDate(-7), endTime: getRelativeDate(-2), status: 'finished' },
  { id: 'T052', empId: 'E007', city: '长沙', tripType: 'domestic', startTime: getRelativeDate(5), endTime: getRelativeDate(8), status: 'upcoming' },
  { id: 'T053', empId: 'E008', city: '罗马', tripType: 'overseas', startTime: getRelativeDate(-3), endTime: getRelativeDate(2), status: 'ongoing' },
  { id: 'T054', empId: 'E009', city: '宁波', tripType: 'domestic', startTime: getRelativeDate(-8), endTime: getRelativeDate(-5), status: 'finished' },
  { id: 'T055', empId: 'E010', city: '马德里', tripType: 'overseas', startTime: getRelativeDate(2), endTime: getRelativeDate(7), status: 'upcoming' },
  { id: 'T056', empId: 'E011', city: '乌鲁木齐', tripType: 'domestic', startTime: getRelativeDate(-5), endTime: getRelativeDate(-1), status: 'finished' },
  { id: 'T057', empId: 'E012', city: '新加坡', tripType: 'overseas', startTime: getRelativeDate(0), endTime: getRelativeDate(4), status: 'ongoing' },
  { id: 'T058', empId: 'E013', city: '拉萨', tripType: 'domestic', startTime: getRelativeDate(-10), endTime: getRelativeDate(-6), status: 'finished' },
  { id: 'T059', empId: 'E014', city: '波士顿', tripType: 'overseas', startTime: getRelativeDate(6), endTime: getRelativeDate(11), status: 'upcoming' },
  { id: 'T060', empId: 'E015', city: '太原', tripType: 'domestic', startTime: getRelativeDate(-1), endTime: getRelativeDate(3), status: 'ongoing' },
]