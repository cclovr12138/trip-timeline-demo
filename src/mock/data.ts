...
export const trips: MockTrip[] = [
  ...
  // E016-E050 每人至少1条行程
  { id: 'T061', empId: 'E016', city: '西安', tripType: 'domestic', startTime: getRelativeDate(-3), endTime: getRelativeDate(1), status: 'ongoing' },
  { id: 'T062', empId: 'E017', city: '重庆', tripType: 'domestic', startTime: getRelativeDate(-8), endTime: getRelativeDate(-4), status: 'finished' },
  { id: 'T063', empId: 'E018', city: '武汉', tripType: 'domestic', startTime: getRelativeDate(2), endTime: getRelativeDate(5), status: 'upcoming' },
  { id: 'T064', empId: 'E019', city: '东京', tripType: 'overseas', startTime: getRelativeDate(-5), endTime: getRelativeDate(0), status: 'ongoing' },
  { id: 'T065', empId: 'E020', city: '深圳', tripType: 'domestic', startTime: getRelativeDate(3), endTime: getRelativeDate(6), status: 'upcoming' },
  { id: 'T066', empId: 'E021', city: '南京', tripType: 'domestic', startTime: getRelativeDate(-12), endTime: getRelativeDate(-8), status: 'finished' },
  { id: 'T067', empId: 'E022', city: '成都', tripType: 'domestic', startTime: getRelativeDate(-2), endTime: getRelativeDate(1), status: 'ongoing' },
  { id: 'T068', empId: 'E023', city: '天津', tripType: 'domestic', startTime: getRelativeDate(4), endTime: getRelativeDate(7), status: 'upcoming' },
  { id: 'T069', empId: 'E024', city: '广州', tripType: 'domestic', startTime: getRelativeDate(-6), endTime: getRelativeDate(-2), status: 'finished' },
  { id: 'T070', empId: 'E025', city: '青岛', tripType: 'domestic', startTime: getRelativeDate(1), endTime: getRelativeDate(4), status: 'upcoming' },
  { id: 'T071', empId: 'E026', city: '济南', tripType: 'domestic', startTime: getRelativeDate(-9), endTime: getRelativeDate(-5), status: 'finished' },
  { id: 'T072', empId: 'E027', city: '杭州', tripType: 'domestic', startTime: getRelativeDate(-3), endTime: getRelativeDate(1), status: 'ongoing' },
  { id: 'T073', empId: 'E028', city: '厦门', tripType: 'domestic', startTime: getRelativeDate(5), endTime: getRelativeDate(8), status: 'upcoming' },
  { id: 'T074', empId: 'E029', city: '苏州', tripType: 'domestic', startTime: getRelativeDate(-14), endTime: getRelativeDate(-10), status: 'finished' },
  { id: 'T075', empId: 'E030', city: '长沙', tripType: 'domestic', startTime: getRelativeDate(-2), endTime: getRelativeDate(2), status: 'ongoing' },
  { id: 'T076', empId: 'E031', city: '昆明', tripType: 'domestic', startTime: getRelativeDate(6), endTime: getRelativeDate(9), status: 'upcoming' },
  { id: 'T077', empId: 'E032', city: '沈阳', tripType: 'domestic', startTime: getRelativeDate(-7), endTime: getRelativeDate(-3), status: 'finished' },
  { id: 'T078', empId: 'E033', city: '大连', tripType: 'domestic', startTime: getRelativeDate(-1), endTime: getRelativeDate(3), status: 'ongoing' },
  { id: 'T079', empId: 'E034', city: '无锡', tripType: 'domestic', startTime: getRelativeDate(3), endTime: getRelativeDate(6), status: 'upcoming' },
  { id: 'T080', empId: 'E035', city: '宁波', tripType: 'domestic', startTime: getRelativeDate(-11), endTime: getRelativeDate(-7), status: 'finished' },
  { id: 'T081', empId: 'E036', city: '郑州', tripType: 'domestic', startTime: getRelativeDate(-4), endTime: getRelativeDate(0), status: 'ongoing' },
  { id: 'T082', empId: 'E037', city: '哈尔滨', tripType: 'domestic', startTime: getRelativeDate(5), endTime: getRelativeDate(9), status: 'upcoming' },
  { id: 'T083', empId: 'E038', city: '石家庄', tripType: 'domestic', startTime: getRelativeDate(-15), endTime: getRelativeDate(-11), status: 'finished' },
  { id: 'T084', empId: 'E039', city: '太原', tripType: 'domestic', startTime: getRelativeDate(-2), endTime: getRelativeDate(2), status: 'ongoing' },
  { id: 'T085', empId: 'E040', city: '南昌', tripType: 'domestic', startTime: getRelativeDate(4), endTime: getRelativeDate(7), status: 'upcoming' },
  { id: 'T086', empId: 'E041', city: '贵阳', tripType: 'domestic', startTime: getRelativeDate(-8), endTime: getRelativeDate(-4), status: 'finished' },
  { id: 'T087', empId: 'E042', city: '乌鲁木齐', tripType: 'domestic', startTime: getRelativeDate(-3), endTime: getRelativeDate(1), status: 'ongoing' },
  { id: 'T088', empId: 'E043', city: '拉萨', tripType: 'domestic', startTime: getRelativeDate(7), endTime: getRelativeDate(11), status: 'upcoming' },
  { id: 'T089', empId: 'E044', city: '三亚', tripType: 'domestic', startTime: getRelativeDate(-13), endTime: getRelativeDate(-9), status: 'finished' },
  { id: 'T090', empId: 'E045', city: '北京', tripType: 'domestic', startTime: getRelativeDate(-1), endTime: getRelativeDate(3), status: 'ongoing' },
  { id: 'T091', empId: 'E046', city: '上海', tripType: 'domestic', startTime: getRelativeDate(5), endTime: getRelativeDate(8), status: 'upcoming' },
  { id: 'T092', empId: 'E047', city: '深圳', tripType: 'domestic', startTime: getRelativeDate(-10), endTime: getRelativeDate(-6), status: 'finished' },
  { id: 'T093', empId: 'E048', city: '广州', tripType: 'domestic', startTime: getRelativeDate(-4), endTime: getRelativeDate(0), status: 'ongoing' },
  { id: 'T094', empId: 'E049', city: '成都', tripType: 'domestic', startTime: getRelativeDate(2), endTime: getRelativeDate(5), status: 'upcoming' },
  { id: 'T095', empId: 'E050', city: '武汉', tripType: 'domestic', startTime: getRelativeDate(-7), endTime: getRelativeDate(-3), status: 'finished' },
  // E002补第4条
  { id: 'T096', empId: 'E002', city: '台北', tripType: 'overseas', startTime: getRelativeDate(11), endTime: getRelativeDate(15), status: 'upcoming' },
]